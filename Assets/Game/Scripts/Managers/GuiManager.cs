...
namespace MadFireOn
{
    ...
    public class Settings
    {
        ...
        public string facebookPageLink = "";
...
#region Settings
        ...
        {//open the url
            music.PlayOneShot(sfx[0]);
            Application.OpenURL(settings.facebookPageLink);
        ...
        {
            music.PlayOneShot(sfx[0]);
            Application.OpenURL(settings.twitterLink);
...
#if UNITY_ANDROID
            Application.OpenURL(rate.AndroidUrl);
#elif UNITY_IOS
            Application.OpenURL(rate.iosUrl);
#endif
